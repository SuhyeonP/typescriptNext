...
import { TableContext, CODE, Codes } from '../../pages/game/mine';
import { openCell, clickMine, questionCell, flagMine, normalizeCell } from '../../exporthing/mineAction';
...
export default memo(Td);//최적화를 위한 memo